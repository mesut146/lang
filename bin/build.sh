...
vendor=x4 compiler_name=$name version=1.1 $compiler c -norun -cache -noroot -stdpath $dir/../src -i $dir../src -out $build -flags "$dir/../cpp_bridge/build/libbridge.a $build/std.a /usr/lib/llvm-16/lib/libLLVM.so -lstdc++" -name $name $dir/../src/parser
